# <img src="https://i.ibb.co/fCd2T2P/inv-mechagonspidertank-junker-Nero-AI-Anime-Face.jpg" alt="Discord" width="25"/> Noobs Lockout Sharing
  
*With love, from the Burger*
...
✅ Group Lead doesn't need to be present.
...
2. Whisper `/w Touchmymana-Draenor !id` to receive a lockout.
...
**Siege of Orgrimmar [N/H]** | Kor'kron | <img src="https://wow.zamimg.com/images/wow/icons/large/inv_misc_enggizmos_18.jpg" width="25" height="25" style="object-fit: contain; margin-right: 2px;"> <a href="https://www.wowhead.com/item=105751/korkron-shamans-treasure" target="_blank">Kor'kron Shaman's Treasure</a> (Shaman Set) |
